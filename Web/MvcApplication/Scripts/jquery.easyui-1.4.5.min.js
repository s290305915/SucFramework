...
},beforePageText:"第",afterPageText:"页 {pages}",displayMsg:"展示从 {from} 到 {to} 条，共 {total} 条",nav:{first:{iconCls:"pagination-first",handler:function(){
...
_aa6(this,q);
}},currentText:"Today",closeText:"关闭",okText:"确定",buttons:[{text:function(_abb){
